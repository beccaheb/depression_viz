---
title: Prevalence of depressive symptomatology with a focus on intersectionality
...
# Variables: occupation (unemployed (unemp), informal (inform), formal (form)), education (less than high school (low), high school or more (high)), gender (women (W), men (M)), age (20-39, 40-59, 60+), smoking (does not currently smoke tobacco (no), currently smokes tobacco (smokes))

## 1. Intersectionality: Ocupation, Gender, Age, & Tobacco {.tabset .tabset-fade}
...
## **2. Intersectionality: Education, Gender, Age, & Tobacco** {.tabset .tabset-fade}
